  ...
  return (
    ...
    >
      <div className="relative aspect-[4/3] overflow-hidden">
        <img
          src={service.image}
          alt={`${service.title} hos Vikings Car Care i Karlskrona`}
      ...
      <div className="p-5">
        <h3 className="text-xl font-black text-ink dark:text-white">{service.title}</h3>
        <p className="mt-3 min-h-[96px] text-sm leading-7 text-zinc-600 dark:text-zinc-300">{service.description}</p>
